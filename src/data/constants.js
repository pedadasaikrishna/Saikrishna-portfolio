export const Bio = {
  ...
  description:"I am a dedicated student 📚 and MERN stack developer 💻 with a strong passion for problem-solving 🧩 and programming. As an AI & ML enthusiast 🤖, I continually seek to deepen my knowledge and skills in these fields. My commitment to learning and innovation drives me to tackle challenges head-on 💪, and I am eager to contribute to impactful projects that leverage technology for positive change 🌟.",
  github: "https://github.com/pedadasaikrishna",
  resume:"",
  linkedin: " https://www.linkedin.com/in/pedada-sai-krishna-94339b297/",
  twitter: " ",
  insta: "https://www.instagram.com/_p_s_k_12_/ ",
  facebook: " ",
};
...
,  
  {
    ...
    skills: [
      ...
      },
      {
        name: "UIVerse",
        image:
          "https://uiverse.io/assets/logo-png-BXFOQKfc.png",
      },
      {
        name:"Google Colab",
...
export const education = [
  {
    id: 0,
    img: "https://www.vishnu.edu.in/upload_news/newlogo.bmp",
    school: "Vishnu Institute of Technology, Bhimavaram",
    date: "📅 Oct 2023 - Sep 2027",
    presentGrade: "🎓 9.45 CGPA",
    desc: "I am currently pursuing a Bachelor's degree in Computer Science and Engineering with a specialization in AI & ML at Vishnu Institute of Technology, Bhimavaram. So far, I have completed 2 semesters with a CGPA of 9.45. I have taken courses in Data Structures, Algorithms, Object-Oriented Programming through Java, Database Management Systems, among others, where I am learning and working on exciting projects. 🚀",
  ...
  },
  {
    ...
    school: "Bhashyam Jr College",
    date: "📅 2021 - 2023",
    grade: "🏆 96.9%",
    desc: "I completed my Class 12 education at Bhashyam Jr College, where I studied Science with an introduction to Computer Science. 🖥️",
    degree: "📜 AP Board Certification for Higher Secondary Education (+2)",
  },
  {
    id: 2,
    img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTV4f3szxe4WVLRtZ6kEPWvnnMs-gEfAm0Lmg&s",
    ...
    grade: "🏅 100%",
    desc: "I completed my Class 10 education at Bhashyam High School, where I studied Science along with other core subjects. 📖",
    degree: "📜 Secondary School Education (SSE) Certification",
  },
];
...
export const TimeLineData = [
  ...
  { year: 2023, text: "Entered into Btech & coding world" },
  { year: 2024, text: "Stared doing my Web project's using MERN Stack" },
];
